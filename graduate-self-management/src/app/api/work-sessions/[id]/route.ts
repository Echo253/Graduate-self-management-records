...
export async function PATCH(
  ...
  try {
    ...
    // 获取日期基准（使用原始记录的日期）
    const baseDate = new Date(workSession.startTimestamp)
    ...
    const finalStartTimestamp = updateData.startTimestamp || workSession.startTimestamp
    const finalEndTimestamp = updateData.endTimestamp || workSession.endTimestamp
